            ...
            {filtersOpen && (
              <>
                ...
                <div className="fixed bottom-0 left-0 right-0 z-50 p-6 rounded-t-3xl shadow-2xl animate-slideInRight"
                  ...
                  <FilterPanel maxPrice={maxPrice} setMaxPrice={setMaxPrice} sortBy={sortBy} setSortBy={setSortBy} language={language} />
                </div>
              </>
            )}
          </div>
...
function FilterPanel({
  maxPrice, setMaxPrice, sortBy, setSortBy, language
}: {
