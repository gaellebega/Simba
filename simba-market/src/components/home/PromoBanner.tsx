  ...
  return (
    <section className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto py-8">
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        {/* Main promo */}
        <div className="sm:col-span-2 relative overflow-hidden rounded-2xl min-h-50 flex items-center p-8">
          <img
            src="https://images.unsplash.com/photo-1610348725531-843dff563e2c?w=800&h=400&fit=crop"
            alt="Fresh produce deals"
            className="absolute inset-0 w-full h-full object-cover"
          />
          <div className="absolute inset-0 bg-linear-to-r from-orange-600/90 to-orange-500/60" />
        ...
        <div className="flex flex-col gap-4">
          <div className="relative overflow-hidden rounded-2xl flex-1 min-h-22.5 flex items-center p-5">
            <img
              src="https://images.unsplash.com/photo-1619566636858-adf3ef46400b?w=400&h=200&fit=crop"
              alt="Fresh fruits"
              className="absolute inset-0 w-full h-full object-cover"
            />
            <div className="absolute inset-0 bg-linear-to-r from-green-600/85 to-green-500/60" />
            <div className="relative z-10">
          ...
          <div className="relative overflow-hidden rounded-2xl flex-1 min-h-22.5 flex items-center p-5">
            <img
              ...
              className="absolute inset-0 w-full h-full object-cover"
            />
            <div className="absolute inset-0 bg-linear-to-r from-emerald-700/85 to-emerald-600/60" />
            <div className="relative z-10">
